...
export type UserRole = 'user' | 'vip' | 'moderator' | 'admin' | 'super_admin' | 'super_owner' | 'owner';
...
export const ROLE_HIERARCHY: Record<UserRole, RoleInfo> = {
  user: { role: 'user', level: 1, name_ar: 'عضو', name_en: 'Member', icon: '👤', color: '#94a3b8' },
  vip: { role: 'vip', level: 2, name_ar: 'عضو مميز', name_en: 'VIP', icon: '⭐', color: '#fbbf24' },
  moderator: { role: 'moderator', level: 3, name_ar: 'مشرف', name_en: 'Moderator', icon: '🛡️', color: '#3b82f6' },
  admin: { role: 'admin', level: 4, name_ar: 'إدارة', name_en: 'Admin', icon: '⚙️', color: '#8b5cf6' },
  super_admin: { role: 'super_admin', level: 5, name_ar: 'إدارة عليا', name_en: 'Super Admin', icon: '👑', color: '#ec4899' },
  super_owner: { role: 'super_owner', level: 6, name_ar: 'مالك الموقع', name_en: 'Site Owner', icon: '🏆', color: '#f59e0b' },
  owner: { role: 'owner', level: 6, name_ar: 'مالك الموقع', name_en: 'Site Owner', icon: '🏆', color: '#f59e0b' },
};
